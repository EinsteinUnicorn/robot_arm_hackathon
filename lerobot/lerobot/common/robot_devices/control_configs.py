...
@ControlConfig.register_subclass("action_stream")
@dataclass
class ActionStreamControlConfig(ControlConfig):
    # Limit the maximum frames per second. By default, no limit.
    fps: int | None = None
    # Display all cameras on screen
    display_data: bool = False
    # Path to the file containing joint angles, or list of joint angles directly
    actions: str | list[list[float]] | None = None
